...
import "./NewReceivingNotes.scss";
import NewItemHeader from "../newItemHeader/NewItemHeader";

function NewReceivingNotes() {
  ...
  return (
    <div className="NewReceivingNotes">
      <NewItemHeader name={'New Receiving Notes'}/>
      <div className="NewReceivingNotes__form rounded">
        <form action="" className="py-2 px-4">
          <div className="NewReceivingNotes__form__1">
          ...
          <div className=" d-flex gap-3">
            <div className="NewReceivingNotes__form__1 w-100 h-25">
              <div className="input__form ">
                <label htmlFor="Address">
                  Address<span className="text-danger">*</span>
                </label>
            ...
            <div className="NewReceivingNotes__form__1 w-100 d-flex flex-column align-items-end">
          ...
          {/* advanced  */}
          <div className="NewReceivingNotes__form__advanced">
            <button
              type="button"
            ...
            {advanced && (
              <>
                {" "}
                <div className="NewReceivingNotes__form__1 d-flex flex-column py-2 gap-0 border-bottom">
                  <div className="input__form">
                ...
                <div className="NewReceivingNotes__form__1 border-bottom">
                    <div className="input__form">
          ...
          <div className="NewReceivingNotes__form__1 choose__file d-flex flex-column gap-2 align-items-center">
          ...
          <div className="NewReceivingNotes__form__submit px-4 shadow-lg py-2">
            <div>
...
export default NewReceivingNotes;
