...
function NewMemo() {
  ...
  return (
    <>
      ...
      <NewItemHeader name={'New Credit Memo'}/>
        <div className="NewMemo__form rounded">
          <form action="" className="py-2 px-4">
            <div className="NewMemo__form__1">
            ...
            <div className="NewInvoice__form__1 py">
              <div className="input__form gap-0 pb-4 d-flex gap-2">
                <span className={`border border-dark bg-light py-2 `} onClick={() => setView(true)}>
                  Product and Services
                </span>
                <span className={`border border-dark bg-light py-2 w-25 `}>
                  Delete
                </span>
              </div>
            ...
            <div className=" d-flex gap-3">
              <div className="NewMemo__form__1 w-100 h-25">
                <div className="input__form ">
                  <label htmlFor="Address">
                    Address<span className="text-danger">*</span>
                  </label>
              ...
              <div className="NewMemo__form__1 w-100 d-flex flex-column align-items-end">
            ...
            {/* advanced  */}
            <div className="NewMemo__form__advanced">
              <button
                type="button"
              ...
              {advanced && (
                <>
                  {" "}
                  <div className="NewMemo__form__1 d-flex flex-column py-2 gap-0 border-bottom">
                    <div className="input__form">
                  ...
                  <div className="NewMemo__form__1 border-bottom">
                    <div className="input__form">
            ...
            <div className="NewMemo__form__1 choose__file d-flex flex-column gap-2 align-items-center">
            ...
            <div className="NewMemo__form__submit px-4 shadow-lg py-2">
              <div>
