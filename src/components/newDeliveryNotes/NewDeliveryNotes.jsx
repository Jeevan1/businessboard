...
import "./NewDeliveryNotes.scss";
import NewItemHeader from "../newItemHeader/NewItemHeader";

function NewDeliveryNotes() {
  ...
  return (
    <div className="NewDeliveryNotes">
      <NewItemHeader name={'New Delivery Notes'}/>
      <div className="NewDeliveryNotes__form rounded">
        <form action="" className="py-2 px-4">
          <div className="NewDeliveryNotes__form__1">
          ...
          <div className=" d-flex gap-3">
            <div className="NewDeliveryNotes__form__1 w-100 h-25">
              <div className="input__form ">
                <label htmlFor="Address">
                  Address<span className="text-danger">*</span>
                </label>
            ...
            <div className="NewDeliveryNotes__form__1 w-100 d-flex flex-column align-items-end">
          ...
          {/* advanced  */}
          <div className="NewDeliveryNotes__form__advanced">
            <button
              type="button"
            ...
            {advanced && (
              <>
                {" "}
                <div className="NewDeliveryNotes__form__1 d-flex flex-column py-2 gap-0 border-bottom">
                  <div className="input__form">
                  ...
                  <div className="input__form">
                    ...
                    <textarea
                      ...
                      cols="90"
                      rows="3"
                      className="border-0 textarea bg-light p-2"
                    ></textarea>
                  </div>
                </div>
                <div className="NewDeliveryNotes__form__1 border-bottom">
                  <div className="input__form">
                ...
                <div className="NewDeliveryNotes__form__1 border-bottom">
                  <div className="input__form">
                    <label htmlFor="po">PO Number</label>
                    <textarea
                      className="textarea border-0 border-bottom"
                      name=""
                      id=""
                      cols="90"
                      rows="3"
          ...
          <div className="NewDeliveryNotes__form__1 choose__file d-flex flex-column gap-2 align-items-center">
          ...
          <div className="NewDeliveryNotes__form__submit px-4 shadow-lg py-2">
            <div>
...
export default NewDeliveryNotes;
