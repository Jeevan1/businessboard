...
function AddLead() {
  ...
  return (
    <div className="AddLead">
      <NewItemHeader name={'New Lead'}/>
      <div className="AddLead__form rounded">
        <form action="" className="py-2 px-4">
          <div className="AddLead__form__1">
            <h5 className="AddLead__form__1__left">Overview</h5>
            <div className="AddLead__form__1__right">
              <div>
          ...
          <hr />
          <div className="AddLead__form__1">
            <h5 className="AddLead__form__1__left">Address</h5>
            <div className="AddLead__form__1__right">
              <div className="input__form">
          ...
          <hr />
          <div className="AddLead__form__1">
            <h5 className="AddLead__form__1__left">Contacts</h5>
            <div className="AddLead__form__1__right">
              <div className="input__form">
          ...
          {/* advanced  */}
          <div className="AddLead__form__advanced">
            ...
            {advanced &&
            <> <div className="AddLead__form__1">
              <h5 className="AddLead__form__1__left">Finance</h5>
              <div className="AddLead__form__1__right">
                <div className="input__form">
                  <InputOption
            ...
            <hr />
            <div className="AddLead__form__1">
              <h5 className="AddLead__form__1__left">Business</h5>
              <div className="AddLead__form__1__right">
                <div className="input__form">
                  <InputOption
                    label={"Payenment Terms"}
            ...
            <hr />
            <div className="AddLead__form__1">
              <h5 className="AddLead__form__1__left">Notes</h5>
              <div className="AddLead__form__1__right">
                <div className="input__form">
                  <textarea name="" id="" cols="" rows="10" placeholder="Notes" className="p-2 w-100 border"></textarea>
                </div>
              </div>
            </div>
            </>}
          ...
          <div className="AddLead__form__submit px-4 shadow-lg py-2">
            <div>
