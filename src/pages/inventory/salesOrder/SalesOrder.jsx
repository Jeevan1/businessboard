...
function SalesOrder() {
  ...
  return (
    <div className="SalesOrder w-100">
      <div className="container-fluid p-0 border">
        <div className="SalesOrder__top">
          <Header data={ownLinks} rightLinks={rightLinks} moreLinks={moreLinks} menuLinks={menuLinks}/>
        </div>
        <div className="SalesOrder__content p-3 mt-5">
          <div className="SalesOrder__content__1 d-flex justify-content-between align-items-center">
            <h5 className="">Sales Order</h5>
            <div className=" d-flex gap-2">
              <Link to={'/new/sales_order'}>
              <button className=" rounded px-3 py-2">New Sales Order</button></Link>
          ...
          <div className="SalesOrder__content__2 my-5">
            <StaticContent name={'SalesOrder'} desc={'A Quote is an offer to sell specific goods and services at a specific price. Once SalesOrder are accepted they can be converted into Invoices or Sales Orders.'}/>
          </div>
        </div>
      </div>
    </div>
