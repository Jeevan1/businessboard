        ...
        <div className="RecevingNotes__content p-3 mt-5">
          ...
          <div className="RecevingNotes__content__2 my-5">
            <StaticContent
              name={"RecevingNotes"}
              desc={
                "A Quote is an offer to sell specific goods and services at a specific price. Once RecevingNotes are accepted they can be converted into Invoices or Sales Orders."
              }
            />
          </div>
        </div>
