...
function CreditMemo() {
  ...
  return (
    <div className="CreditMemo w-100">
      <div className="container-fluid p-0 border">
        <div className="CreditMemo__top">
          <Header data={ownLinks} rightLinks={rightLinks} moreLinks={moreLinks} menuLinks={menuLinks}/>
        </div>
        <div className="CreditMemo__content p-3 mt-5">
          <div className="CreditMemo__content__1 d-flex justify-content-between align-items-center">
            <h5 className="">Credit Memo</h5>
            <div className=" d-flex gap-2">
              <Link to={'/credit_memo/new'}>
              <button className=" rounded px-3 py-2">New Credit Memo</button></Link>
          ...
          <div className="Credit Memo__content__2 my-5">
