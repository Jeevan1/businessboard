...
function Payenment() {
  ...
  return (
    <div className="Payenment w-100">
      <div className="container-fluid p-0 border">
        <div className="Payenment__top">
          <Header data={ownLinks} rightLinks={rightLinks} moreLinks={moreLinks} menuLinks={menuLinks}/>
        </div>
        <div className="Payenment__content p-3 mt-5">
          <div className="Payenment__content__1 d-flex justify-content-between align-items-center">
            <h5 className="">Payenment</h5>
            <div className=" d-flex gap-2">
              <button className=" rounded px-3 py-2">Receive Customer Payenment</button>
          ...
          <div className="Payenment__content__2 my-5">
            <StaticContent name={'Payenment'} desc={'You haven’t received any Customer Payments. Payments can be received directly inside an Invoice, or use ‘Receive Customer Payment’ to record multiples payment at the same time.'}/>
          </div>
        </div>
      </div>
    </div>
